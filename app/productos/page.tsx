...
export default async function ProductosPage({ searchParams }: PageProps) {
  ...
  const hasFilters = !!(
    ...
    params.categoria || params.buscar || params.precioMin || params.precioMax
  )
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Buscador — preserva filtros activos como hidden inputs */}
      <form method="get" action="/productos" className="mb-5">
        {params.pais      && <input type="hidden" name="pais"   value={params.pais} />}
        {params.genero    && <input type="hidden" name="genero" value={params.genero} />}
      ...
      {sorted.length === 0 ? (
        <div className="text-center py-24">
          ...
          <p className="text-gray-500 mb-6">
            No encontramos productos con esos filtros. Intenta con otras opciones.
          </p>
